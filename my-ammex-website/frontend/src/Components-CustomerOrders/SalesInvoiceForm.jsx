...
const printStyles = `
  @media print {
    ...
    * {
    ...
    .modal-title::before {
      content: "Sales Invoice" !important;
...
export default function SalesInvoiceForm({ onSubmit, onClose, nextDocNo }) {
  // Form state
  const [customer, setCustomer] = useState('');
  const [invoiceNumber, setInvoiceNumber] = useState(nextDocNo || '');
        ...
        <div className="w-full max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-x-14 gap-y-6 ">
            ...
            <div className="md:col-span-3 grid gap-y-6">
              <div>
                <label className="block text-md font-medium">Customer Name</label>
                <input 
                  type="text" 
                  className={`w-full max-w-xl p-2 border ${formErrors.customer ? 'border-red-500' : 'border-gray-300'} rounded focus:border-gray-400 focus:outline-none`}
              ...
              <div>
                <label className="block text-md font-medium">Invoice Number</label>
                <input 
                  type="text" 
                  className={`w-full max-w-xs p-2 border ${formErrors.invoiceNumber ? 'border-red-500' : 'border-gray-300'} rounded focus:border-gray-400 focus:outline-none bg-gray-100`}
            ...
            <div className="md:col-span-2 grid gap-y-6">
              <div>
                <label className="block text-md font-medium">Invoice Date</label>
                <input 
                  type="date" 
                  className={`w-full p-2 border ${formErrors.invoiceDate ? 'border-red-500' : 'border-gray-300'} rounded focus:border-gray-400 focus:outline-none`}
                  value={invoiceDate}
                  onChange={(e) => {
                    setInvoiceDate(e.target.value);
                    setFormErrors(prev => ({ ...prev, invoiceDate: null }));
                  }}
                />
              ...
              <div>
                <label className="block text-md font-medium">Due Date</label>
                <input 
                  type="date" 
                  className={`w-full p-2 border ${formErrors.dueDate ? 'border-red-500' : 'border-gray-300'} rounded focus:border-gray-400 focus:outline-none`}
                  value={dueDate}
                  onChange={(e) => {
          ...
          <div className="mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                <p className="mt-2"><strong>Invoice Number:</strong> {invoiceNumber}</p>
              </div>
              <div>
                <p><strong>Date:</strong> {invoiceDate}</p>
                <p className="mt-2"><strong>Due Date:</strong> {dueDate}</p>
              </div>
            </div>
