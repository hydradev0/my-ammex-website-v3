...
export default function SalesQuoteForm({ onSubmit, onClose, nextDocNo }) {
  // Form state
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-x-14 gap-y-6 ">
            ...
            <div className="md:col-span-3 grid gap-y-6">
              <div>
                ...
                <input 
                  type="text" 
                  className={`w-full max-w-xl p-2 border border-gray-300 rounded focus:border-gray-400 focus:outline-none`}
