...
export default function SalesOrderForm({ onSubmit, onClose, nextDocNo }) {
  // Form state
  ...
  const validateForm = () => {
    ...
    } else if (new Date(dueDate) < new Date(orderDate)) {
      errors.dueDate = 'Due date must be after order date';
    }
        ...
        <div className="w-full max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-x-14 gap-y-6 ">
            ...
            <div className="md:col-span-3 grid gap-y-6">
              ...
              <div>
                <label className="block text-md font-medium">Sales Order No.</label>
                <input 
                  type="text" 
            ...
            <div className="md:col-span-2 grid gap-y-6">
              <div>
                <label className="block text-md font-medium">SO Date</label>
                <input 
                  type="date" 
          ...
          <div className="mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                <p className="mt-2"><strong>SO Number:</strong> {orderNumber}</p>
              </div>
              <div>
